...
/*
static 블럭
: 동일 클래스내 main()메서드 보다 먼저 실행되는 블럭으로
main 메서드의 실행코드가 없어도 먼저 실행된다. 또한 생성자보다 
먼저 실행된다.
 */
...
//		instanceMethod();
	...
	/* 생성자 메서드 정의 : 생성자에서는 정적멤버에 접근이
	가능하다. 일반적인 멤버변수와 동일하다. */
	...
	public static void main(String[] args) {
		...
		/* static블럭내에서 선언된 변수는 지역변수이므로
		main 메서드에서는 사용할 수 없다. 해당 지역에서만 
		사용할 수 있다. */
//		System.out.println("localVar="+ localVar);
