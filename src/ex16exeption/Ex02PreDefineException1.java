...
public class Ex02PreDefineException1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			예외가 발생되는 시점
			해당 코드가 실행될때 예외가 발생하게되고 JVM이 예외객체
			를 생성해서 프로그램으로 던진다 (throw)
			 */
			intArr[2] = 300;
			 ...
			 */
			// 예외메세지 1 : 개발자가 임의로 메세지를 출력한다.
			System.out.println("예외 발생");
			// 예외메세지 2 : 간략한 설명을 출력한다.
			System.out.println("예외메세지: "+ e.getMessage());
			// 예외메세지 3 : 예외에 대한 디테일한 설명을 출력한다.
			// 가장많이사용됨
			e.printStackTrace();
		}
