...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		배열명.length : 해당 배열의 크기를 반환한다.
			배열의 크기가 변경되는 경우를 유연하게 대처할 수 있다
		 */
		int[] arrNumver = new int[40];
		// 배열의 각 원소를 초기화한다.
		for(int i=0; i<arrNumver.length ; i++) {
			arrNumver[i] = i+10;
		}
		// 배열의 각 원소를 출력한다.
		for(int i=0 ; i<40; i++) {
			System.out.println(i+ "번방의 값= "+ arrNumver[i]);
		}
		System.out.println("=============");
