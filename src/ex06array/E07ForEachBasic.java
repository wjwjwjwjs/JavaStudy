...
/*
foreach문 (개선된 for문)
: 배열의 일부가 아니라 전체를 잠조해야할때 주로 사용하는 for문을
...
public class E07ForEachBasic {
	...
	public static void main(String[] args) {
		...
		/* 배열 arr의 원소를 순서대로 하나씩 함조하요 출력하고,
		더 이상 참조할 원소가 없을때 for문이 자동으로 종료된다. */
		sum = 0;
		for(int e : arr) {
			// 배열의 원소들이 순서대로 출력된다.
			System.out.print(e+" ");
