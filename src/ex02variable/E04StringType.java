...
public class E04StringType {
	...
	public static void main(String[] args) {
		...
		/*
		String 클래스 : 참조형 변수로써 기본자료형이 아닌 클래스로
			문자열을 저장하고, 조작하는 기능을 가지고 있다.
			자바에서는 문자열을 표현할때 "으로 감싸주면 되고 연결시에는
			+ 기호를 사용한다.
		 */
		int number ;
		number = 99;
		...
		String plusSting = "기본자료형처럼 사용";
		// +기호는 문자열을 연결하는 기능으로 사용된다
		System.out.println(stringBasic +" "+ plusSting);
