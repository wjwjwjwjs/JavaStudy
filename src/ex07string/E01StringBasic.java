...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/* 기본자료형의 경우 비교연산자 ==을 통해 값에 대한
		비교를 한다. 변수에 값이 할당되어 있으므로 아래와 같이 
		비교할 수 있다. */
		int num1 = 10, num2 = 20;
		...
		/* str1, str2는 String 인스턴스의 참조값을 가지고
		있으므로 아래의 비교는 참조값(주소)에 대한 비교를 하게된다.
		...
		/* equals() 메서드 : Object클래스로 부터 상속받은
		메서드로 실제 저장된 문자열을 비교하도록 정의되어있다.
		즉, 아래는 객체에 저장된 실제 문자열에 대한 비교가 
		이루어진다. */
		if(str1.equals(str2)) {
		...
		따라서 String 객체는 주로 방법2를 통해 사용하는 것이 좋다. */
		String str3 = "자바개발자";
		String str4 = "자바개발자";
